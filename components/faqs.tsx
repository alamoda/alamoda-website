...
export default function Faqs() {
    return (
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 divide-y divide-gray-900/10">
            <h2 className="text-4xl leading-10 tracking-tight text-gray-900">Frequently asked questions</h2>

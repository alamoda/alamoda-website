...
export default function CartItemEntry({ cartItem, cartIndex }: { cartItem: CartItem, cartIndex: number }) {
                ...
                <div className="w-full relative sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                    ...
                    <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <div className="absolute right-0 top-0">
                            <button onClick={() => removeItem(cartIndex)} type="button" className="-m-2 inline-flex p-2 text-gray-400 hover:text-gray-500">

        ...
        <>
            <div>
                <div className="md:flex md:items-center md:justify-between">
                    ...
                    {listUrl &&
                        <a href={listUrl} className="hidden text-sm font-medium text-gray-900 hover:text-gray-700 md:block">
                            Shop the collection
                ...
                <div className="mt-8 text-sm md:hidden">
                    <a href={listUrl} className="font-medium text-gray-900 hover:text-gray-700">
                        Shop the collection
                        <span aria-hidden="true"> &rarr;</span>
                    </a>
                </div>

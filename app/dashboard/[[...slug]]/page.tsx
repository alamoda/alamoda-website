...
export default async function Page({
    ...
    const department = params.slug[0] ? params.slug[0] : '';
    const category = params.slug[1] ? params.slug[1] : '';
    const subcategory = params.slug[2] ? params.slug[2] : '';
    ...
    return (
        <div className="px-4 py-4">
            ...
            <div className='mt-8'>
                <Pagination productCount={count} selectedPage={currentPageNumber} route="dashboard" department={department} category={category} subcategory={subcategory}/>
            </div>
        </div>
    )
}